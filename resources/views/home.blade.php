...
<head>
    ...
    <title>Management Blog - Home</title>
...
<body>
    ...
    <header>
        <div class="container">
            <nav class="navbar">
                <a href="/" class="logo">Management<span>Blog</span></a>
                <div class="nav-links">
    ...
    <section class="hero">
        <div class="container">
            <h1>Welcome to Management Blog</h1>
            <p>Discover amazing articles, tutorials, and insights about Blogs.</p>
